        ...
        <div>
            ...
            {habit && !loading && (
                <form action={updateHabit}>
                    ...
                    <p>Frequency
                        <label>
                            <input type="radio" name="frequency" value="daily" onChange={() => setHabit({ ...habit, frequency: "daily" })} />
                            Daily
                        </label>
                        <label>
                            <input type="radio" name="frequency" value="weekly" onChange={() => setHabit({ ...habit, frequency: "weekly" })} />
                            Weekly
                        </label>
                    </p>
